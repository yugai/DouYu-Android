...
public class LiveFragment extends MVPBaseFragment<LiveContract.View, LivePresenter> implements LiveContract.View {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mLiveAdapter=new LiveAdapter(getActivity(), new LiveAdapter.OnItemClickListener() {
            ...
            public void onItemClick(String roomId) {
                ...
                getActivity().startActivityForResult(intent, MainActivity.OPEN_ROOM_REQ_CODE);
            }
        });
    ...
    @Override
    public void onRequestData(List<DYRoom> DYRooms) {
        mLiveAdapter.addLoadMoreData(DYRooms);
    }

    @Override
    public void onRefreshData(List<DYRoom> DYRooms) {
        mLiveAdapter.addRefreshData(DYRooms);
    }
